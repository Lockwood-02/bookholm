    ...
    <main className="auth-layout">
      <section className="welcome-panel">
        ...
        <div className="welcome-copy">
          ...
          <h1>A home for every book you’ve loved.</h1>
      ...
      <section className="form-panel">
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <label><span className="label-line">Password<span className="hint">At least 6 characters</span></span><input type="password" name="password" value={form.password} onChange={updateField} autoComplete={isSignUp ? 'new-password' : 'current-password'} placeholder="••••••••" minLength="6" required /></label>
  ...
  return (
    <main className="library-page">
      ...
      <section className="library-content">
        <p className="eyebrow">Your private library</p><h1>Welcome home, {name}.</h1>
        <p className="library-lead">Your shelves are ready for their first story.</p>
        <div className="empty-library">
          ...
          <p>Search and bookshelf features are coming next. Your account is connected and ready.</p>
          <button className="primary-button" type="button" disabled>Add your first book soon</button>
        </div>
      </section>
    </main>
  )
